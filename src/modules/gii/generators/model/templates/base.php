...
?>
/**
 * Base <?= $className ?> model class file
 *
 ...
 * property or method in class "<?= $generator->ns ?>\<?= $className ?>".
 *
 * Base <?= $className ?> model class for table "<?= $generator->generateTableName($tableName) ?>".
 *
 * -------------------------------------------------------------------------
 * COLUMN ATTRIBUTES
 * -------------------------------------------------------------------------
