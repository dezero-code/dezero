...
abstract class Country extends \dezero\entity\ActiveRecord
{
    ...
    */
     ...
     * @return ActiveQueryInterface The relational query object.
     */
    public function getAgencies() : ActiveQueryInterface
    {
        return $this->hasMany(Agency::class, ['billing_country_code' => 'country_code']);
    }
     ...
     * @return ActiveQueryInterface The relational query object.
     */
    public function getEventConcerts() : ActiveQueryInterface
    {
        return $this->hasMany(EventConcert::class, ['country_code' => 'country_code']);
    }
