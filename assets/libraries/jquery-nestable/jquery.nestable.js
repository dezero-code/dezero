...
;(function($, window, document, undefined)
{
    ...
    var defaults = {
            ...
            readOnly        : false      // <DEZERO> Readonly mode
        };
    ...
    Plugin.prototype = {
        ...
        init: function()
        {
            ...
            $.each(this.el.find(list.options.itemNodeName), function(k, el) {
                // list.setParent($(el));
                // <DEZERO> PR #103 - https://github.com/dbushell/Nestable/pull/103
                var item = $(el);
                list.setParent(item);
            ...
            // Pull request #87
            // @see https://github.com/dbushell/Nestable/pull/87
        ...
        dragStart: function(e)
        {
            ...
            // Pull request #120
            // @see https://github.com/dbushell/Nestable/pull/120
